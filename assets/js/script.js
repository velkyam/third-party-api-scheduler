...
document.querySelector("#nineInput").value = (localStorage.getItem("nineInput"))
document.querySelector("#tenInput").value = (localStorage.getItem("tenInput"))
document.querySelector("#elevenInput").value = (localStorage.getItem("elevenInput"))
document.querySelector("#twelveInput").value = (localStorage.getItem("twelveInput"))
document.querySelector("#thirteenInput").value = (localStorage.getItem("thirteenInput"))
document.querySelector("#fourteenInput").value = (localStorage.getItem("fourteenInput"))
document.querySelector("#fifteenInput").value = (localStorage.getItem("fifteenInput"))
document.querySelector("#sixteenInput").value = (localStorage.getItem("sixteenInput"))
document.querySelector("#seventeenInput").value = (localStorage.getItem("seventeenInput"))
